...
import { Modal, Button, Input, OAuthModal, OAuthProxyPoolSelect, useOAuthProxyPool } from "@/shared/components";
 ...
 */
export default function GitLabAuthModal({ isOpen, providerInfo, onSuccess, onClose, proxyPools }) {
        ...
        {!mode && (
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <MdiIcon name="lock_open" size={24} className="text-primary" />
                <div>
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-primary hover:bg-primary/5 transition-colors text-left"
              >
                <MdiIcon name="key" size={24} className="text-primary" />
                <div>
