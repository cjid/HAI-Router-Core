    ...
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <BrandLogo variant="full" className="mx-auto mb-4" />
          <p className="text-text-muted text-sm">{BRANDING.tagline}</p>
          ...
          {mustChange ? (
            <form onSubmit={handleSetNewPassword} className="flex flex-col gap-4">
              ...
              <Button
                ...
                variant="primary"
                className="w-full"
                processState={loading ? PROCESS_STATE.SAVING : PROCESS_STATE.IDLE}
                processLabels={{ idle: "Set password", saving: "Setting", success: "Set", error: "Set password" }}
            ...
            {passwordAvailable ? (
              <form onSubmit={handleLogin} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {resetHint && (
                    <p className="text-xs text-text-muted">
                      Forgot password? Open the <code className="bg-sidebar px-1 rounded">HAI-Router</code> CLI on the host → <b>Settings</b> → <b>Reset Password to Default</b>.
                    </p>
                  )}
                </div>
                ...
                <Button
                  ...
                  variant="primary"
                  className="w-full"
                  processState={loading ? PROCESS_STATE.LOADING : PROCESS_STATE.IDLE}
                  processLabels={{
                    idle: retryAfter > 0 ? `Wait ${retryAfter}s` : "Login",
                    loading: "Logging in",
                    error: "Login",
                  }}
