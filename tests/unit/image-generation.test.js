...
describe("handleImageGenerationCore", () => {
  ...
  it("resolves Cloudflare img2img and inpainting URL inputs before sending", async () => {
    ...
    expect(result.success).toBe(true);
    expect(global.fetch).toHaveBeenNthCalledWith(1, "https://example.com/source.png", expect.any(Object));
    expect(global.fetch).toHaveBeenNthCalledWith(2, "https://example.com/mask.png", expect.any(Object));
