...
import { Modal, Button, Input, OAuthProxyPoolSelect, useOAuthProxyPool } from "@/shared/components";

/**
 * Kiro Auth Method Selection Modal
 * Auto-detects token from AWS SSO cache or allows manual import
 */
export default function KiroAuthModal({ isOpen, onMethodSelect, onClose, proxyPools }) {
  const { proxyPoolId, setProxyPoolId, proxyPoolPayload } = useOAuthProxyPool();
  ...
  const handleImportCliProxyJson = async () => {
    ...
    try {
      const res = await fetch("/api/oauth/kiro/import-cli-proxy", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ json: cliProxyJson.trim(), ...proxyPoolPayload }),
      });
  ...
  return (
    <Modal isOpen={isOpen} title="Connect Kiro" onClose={onClose} size="lg">
      <div className="flex flex-col gap-4">
        <OAuthProxyPoolSelect
          proxyPools={proxyPools}
          value={proxyPoolId}
          onChange={setProxyPoolId}
        />
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="shield" size={18} className="text-primary mt-0.5" />
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="business" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="key" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="account_circle" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="code" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="file_upload" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <MdiIcon name="data_object" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
        ...
        {selectedMethod === "api-key" && (
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
              <div className="flex gap-2">
                <MdiIcon name="info" size={18} className="text-blue-600 dark:text-blue-400" />
        ...
        {selectedMethod === "social-google" && (
          <div className="space-y-4">
            <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
              <div className="flex gap-2">
                <MdiIcon name="info" size={18} className="text-amber-600 dark:text-amber-400" />
              ...
              <>
                ...
                {autoDetected && (
                  <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-800">
                    <div className="flex gap-2">
                      <MdiIcon name="check_circle" size={18} className="text-green-600 dark:text-green-400" />
