...
export default function NewProviderPage() {
  ...
  const createProcess = useAsyncProcess({ loadingState: PROCESS_STATE.SAVING, feedbackMs: 0 });
      ...
      <Card>
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              {authMethodOptions.map((method) => (
                ...
                >
                  <MdiIcon name={method.value === "api_key" ? "key" : "lock"} size={18} />
          ...
          <div className="flex gap-3 pt-4 border-t border-border">
            ...
            <Button
              type="submit"
              processState={createProcess.processState}
              processLabels={PROCESS_LABEL_PRESETS.createProvider}
              icon="add"
              fullWidth
              className="flex-1"
            />
