...
const MITM_CA_CN = "HAI-Router MITM Root CA";
const MITM_CA_ORG = "HAI-Router";
const LEGACY_MITM_CA_CN = "9Router MITM Root CA";
...
function generateRootCA() {
  ...
  const attrs = [
    { name: "commonName", value: MITM_CA_CN },
    { name: "organizationName", value: MITM_CA_ORG },
