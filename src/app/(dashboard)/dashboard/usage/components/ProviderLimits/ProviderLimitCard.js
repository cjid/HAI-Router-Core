    ...
    <Card padding="md" className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          title="Refresh quota"
        >
          <MdiIcon name="refresh" size={20} className="text-text-muted" spin={refreshing || loading} />
        </button>
      </div>
      ...
      {!loading && error && (
        <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
          <div className="flex items-start gap-2">
            <MdiIcon name={"error"} size={20} className="text-red-500" />
      ...
      {!loading && !error && message && (
        <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
          <div className="flex items-start gap-2">
            <MdiIcon name={"info"} size={20} className="text-blue-500" />
      ...
      {!loading && !error && !message && quotas?.length === 0 && (
        <div className="text-center py-8 text-text-muted">
          <MdiIcon name={"data_usage"} size={18} className="text-[48px] opacity-20" />
