...
export function TtsExampleCard({ providerId }) {
  ...
  return (
    <>
          ...
          <Row label="Endpoint">
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
              ...
              {tunnelEndpoint && (
                ...
                >
                  <MdiIcon name="wifi_tethering" size={14} />
                  Tunnel
                </button>
              )}
            </div>
              ...
              <Select
                ...
                onChange={(e) => {
                  const m = getModelsByProviderId(providerId)
                    .filter((model) => getModelKind(model) === "tts")
          ...
          <div className="mt-1">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mb-1.5">
              ...
              <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                ...
                >
                  <MdiIcon name={copiedCurl ? "check" : "content_copy"} size={14} />
                ...
                >
                  <MdiIcon name="play_arrow" size={14} spin={running} />
      ...
      {modalOpen && (
        <div
          className={mainPanelOverlayClass("flex items-end justify-center sm:items-center")}
                  ...
                  {filteredLanguages.map((c) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {selectedLang === c.code && (
                          <MdiIcon name="check" size={16} className="text-primary" />
                        )}
                      </div>
                    </button>
                  ))}
