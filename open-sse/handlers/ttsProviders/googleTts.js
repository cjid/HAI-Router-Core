...
async function getToken(credentials = null) {
  ...
  const res = await modalityFetch("https://translate.google.com/", { headers: { "User-Agent": UA } }, credentials || {});
...
export default {
  ...
  async synthesize(text, model, credentials) {
    ...
    const res = await modalityFetch(`https://translate.google.com/_/TranslateWebserverUi/data/batchexecute?${query}`, {
      method: "POST",
