      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          <div className="size-8 rounded bg-linear-to-br from-[#f97815] to-orange-700 flex items-center justify-center text-white">
            <MdiIcon name="hub" size={20} />
          </div>
          <h2 className="text-white text-xl font-bold tracking-tight">{APP_CONFIG.productName}</h2>
        </button>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href={`${GITHUB_CONFIG.repoUrl}#readme`} target="_blank" rel="noopener noreferrer">Docs</a>
          <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors flex items-center gap-1" href={GITHUB_CONFIG.repoUrl} target="_blank" rel="noopener noreferrer">
            GitHub <MdiIcon name="open_in_new" size={14} />
          </a>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <MdiIcon name={mobileMenuOpen ? "close" : "menu"} size={18} />
          </button>
        </div>
      </div>
