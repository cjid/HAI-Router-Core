...
const REPO = `${GITHUB_CONFIG.githubOwner}/${GITHUB_CONFIG.githubRepo}`;
const BRANCH = GITHUB_CONFIG.githubBranch || "master";
const SKILL_PATH = "skills";

export const SKILLS_ENTRY_ID = "hairouter";
...
export const SKILLS = [
  ...
  },
  {
    ...
    description: "Text/image-to-video via xAI Grok Imagine (async job flow).",
