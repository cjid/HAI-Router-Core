...
const PROVIDER_LABEL = "HAI-Router";
...
const buildHairouterConfig = (baseUrl, apiKey, model) => {
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildHairouterConfig(baseUrl, resolveCliApiKey(apiKey), model);
...
export async function DELETE() {
    try {
        ...
        return NextResponse.json({ success: true, message: "HAI-Router config reset to DeepSeek defaults" });
    } catch (error) {
